<?php
class TechTree_Validator_DbRecordNotExists extends TechTree_Validator_Db implements Zend_Validate_Interface
{
    /**
     * Validates, that a database record does not exist in database.
     *
    ...
    public function getMessages()
    {
        ...
        if (!$this->_isValid) {
            return array(
                'DB_RECORD_EXISTS' => 'A record with this value already ' .
                                      'exists in DB.'
            );
        }
    }
