 ...
 *
 * @category Encryption
 * @package  Horizon-Tools
 * @author   "Stefan Krenz" <stefan.krenz@mayflower.de>
 * @license  GPLv2 http://confed.netcommander.ch/techtree/public/LICENSE
 * @link     http://confed.netcommander.ch/techtree/public
 * @version  $Svn: Id$
 */
/**
 * Class for text en- and decryption.
 */
class TechTree_Crypt
{
    /**
    ...
    public function init($encryptionKey = null, $algorithm = null)
    {
        ...
        if ($this->_encDescriptor === null) {
            $encryptionDescriptor = mcrypt_module_open(
                $algorithm,
                '',
                MCRYPT_MODE_ECB,
                ''
